...
(defn run-command
  "Run a parsed command. Returns a string response generated by the Kedai core."
  [parsed-command]

  (str (eval parsed-command)))

(defn make-server-handler
  "Generate a server handler. This handler will be passed to Netty and used to
   act upon incoming requests."
  []
